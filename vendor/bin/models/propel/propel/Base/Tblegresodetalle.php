...
/**
 * Base class that represents a row from the 'tblegresodetalle' table.
 *
 *
 *
 * @package    propel.generator.propel.propel.Base
 */
abstract class Tblegresodetalle implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\TblegresodetalleTableMap';
    ...
    /**
     * The value for the egresodetalleid field.
     *
     * @var        string
     */
    protected $egresodetalleid;

    /**
     * The value for the egresoid field.
     *
     * @var        string
     */
    protected $egresoid;
    ...
    /**
     * Initializes internal state of propel\propel\Base\Tblegresodetalle object.
     */
    ...
    /**
     * Compares this with another <code>Tblegresodetalle</code> instance.  If
     * <code>obj</code> is an instance of <code>Tblegresodetalle</code>, delegates to
     * <code>equals(Tblegresodetalle)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Tblegresodetalle The current object, for fluid interface
     */
    ...
    /**
     * Get the [egresodetalleid] column value.
     *
     * @return string
     */
    public function getEgresodetalleid()
    {
        return $this->egresodetalleid;
    }

    /**
     * Get the [egresoid] column value.
     *
     * @return string
     */
     ...
     */
    public function setEgresodetalleid($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->egresodetalleid !== $v) {
            $this->egresodetalleid = $v;
            $this->modifiedColumns[TblegresodetalleTableMap::COL_EGRESODETALLEID] = true;
        }
    ...
    /**
     * Set the value of [egresoid] column.
     *
     * @param string $v new value
     * @return $this|\propel\propel\Tblegresodetalle The current object (for fluent API support)
     */
    public function setEgresoid($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
    ...
    public function setCantidad($v)
    {
        ...
        if ($this->cantidad !== $v) {
            $this->cantidad = $v;
            $this->modifiedColumns[TblegresodetalleTableMap::COL_CANTIDAD] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TblegresodetalleTableMap::translateFieldName('Egresodetalleid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->egresodetalleid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TblegresodetalleTableMap::translateFieldName('Egresoid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->egresoid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TblegresodetalleTableMap::translateFieldName('Productoid', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTblegresodetalleQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Tblegresodetalle::setDeleted()
     * @see Tblegresodetalle::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTblegresodetalleQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TblegresodetalleTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aTblegreso !== null) {
                if ($this->aTblegreso->isModified() || $this->aTblegreso->isNew()) {
                    $affectedRows += $this->aTblegreso->save($con);
                }
                $this->setTblegreso($this->aTblegreso);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TblegresodetalleTableMap::COL_EGRESODETALLEID)) {
            $modifiedColumns[':p' . $index++]  = 'egresoDetalleId';
        }
        if ($this->isColumnModified(TblegresodetalleTableMap::COL_EGRESOID)) {
            $modifiedColumns[':p' . $index++]  = 'egresoId';
        }
        if ($this->isColumnModified(TblegresodetalleTableMap::COL_PRODUCTOID)) {
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'egresoDetalleId':
                        $stmt->bindValue($identifier, $this->egresodetalleid, PDO::PARAM_INT);
                        break;
                    case 'egresoId':
                        $stmt->bindValue($identifier, $this->egresoid, PDO::PARAM_INT);
                        break;
                    case 'productoId':
    ...
    {
        $pos = TblegresodetalleTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getEgresodetalleid();
                break;
            case 1:
                return $this->getEgresoid();
                break;
            case 2:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Tblegresodetalle'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Tblegresodetalle'][$this->hashCode()] = true;
        $keys = TblegresodetalleTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getEgresodetalleid(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aTblegreso) {
                ...
                $result[$key] = $this->aTblegreso->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\Tblegresodetalle
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setEgresodetalleid($value);
                break;
            case 1:
                $this->setEgresoid($value);
                break;
            case 2:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setEgresodetalleid($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setEgresoid($arr[$keys[1]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\Tblegresodetalle The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TblegresodetalleTableMap::COL_EGRESODETALLEID)) {
            $criteria->add(TblegresodetalleTableMap::COL_EGRESODETALLEID, $this->egresodetalleid);
        }
        if ($this->isColumnModified(TblegresodetalleTableMap::COL_EGRESOID)) {
            $criteria->add(TblegresodetalleTableMap::COL_EGRESOID, $this->egresoid);
        }
        if ($this->isColumnModified(TblegresodetalleTableMap::COL_PRODUCTOID)) {
            $criteria->add(TblegresodetalleTableMap::COL_PRODUCTOID, $this->productoid);
        }
        if ($this->isColumnModified(TblegresodetalleTableMap::COL_CANTIDAD)) {
    ...
    {
        $criteria = ChildTblegresodetalleQuery::create();
        $criteria->add(TblegresodetalleTableMap::COL_EGRESODETALLEID, $this->egresodetalleid);
    ...
    {
        $validPk = null !== $this->getEgresodetalleid();
    ...
    /**
     * Generic method to set the primary key (egresodetalleid column).
     *
    ...
    {
        return null === $this->getEgresodetalleid();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\Tblegresodetalle (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\Tblegresodetalle Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildTblegreso object.
     *
     * @param  ChildTblegreso $v
     * @return $this|\propel\propel\Tblegresodetalle The current object (for fluent API support)
     * @throws PropelException
     */
    public function setTblegreso(ChildTblegreso $v = null)
    {
        ...
        // If this object has already been added to the ChildTblegreso object, it will not be re-added.
        if ($v !== null) {
            $v->addTblegresodetalle($this);
        }
    ...
    /**
     * Get the associated ChildTblegreso object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildTblegreso The associated ChildTblegreso object.
     * @throws PropelException
     */
    public function getTblegreso(ConnectionInterface $con = null)
    {
        if ($this->aTblegreso === null && (($this->tblegreso_egresoid !== "" && $this->tblegreso_egresoid !== null))) {
            ...
            /* The following can be used additionally to
                ...
                $this->aTblegreso->addTblegresodetalles($this);
             */
        }

        return $this->aTblegreso;
    }
    ...
    public function getTblproductos(ConnectionInterface $con = null)
    {
        if ($this->aTblproductos === null && (($this->tblproductos_productoid !== "" && $this->tblproductos_productoid !== null))) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTblproductos->addTblegresodetalles($this);
             */
        }
    ...
    {
        if (null !== $this->aTblegreso) {
            $this->aTblegreso->removeTblegresodetalle($this);
        }
        if (null !== $this->aTblproductos) {
            $this->aTblproductos->removeTblegresodetalle($this);
        }
        $this->egresodetalleid = null;
        $this->egresoid = null;
    ...
    {
        return (string) $this->exportTo(TblegresodetalleTableMap::DEFAULT_STRING_FORMAT);
    }
