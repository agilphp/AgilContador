...
/**
 * Base class that represents a row from the 'tblegreso' table.
 *
 *
 *
 * @package    propel.generator.propel.propel.Base
 */
abstract class Tblegreso implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\TblegresoTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\Tblegreso object.
     */
    ...
    /**
     * Compares this with another <code>Tblegreso</code> instance.  If
     * <code>obj</code> is an instance of <code>Tblegreso</code>, delegates to
     * <code>equals(Tblegreso)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Tblegreso The current object, for fluid interface
     */
     ...
     * @return $this|\propel\propel\Tblegreso The current object (for fluent API support)
     */
    public function setEgresoid($v)
    {
        ...
        if ($this->egresoid !== $v) {
            $this->egresoid = $v;
            $this->modifiedColumns[TblegresoTableMap::COL_EGRESOID] = true;
        }
    ...
    public function setNumero($v)
    {
        ...
        if ($this->numero !== $v) {
            $this->numero = $v;
            $this->modifiedColumns[TblegresoTableMap::COL_NUMERO] = true;
        }
    ...
    public function setFecha($v)
    {
        ...
        if ($this->fecha !== null || $dt !== null) {
            if ($this->fecha === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->fecha->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[TblegresoTableMap::COL_FECHA] = true;
            }
    ...
    public function setComentario($v)
    {
        ...
        if ($this->comentario !== $v) {
            $this->comentario = $v;
            $this->modifiedColumns[TblegresoTableMap::COL_COMENTARIO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TblegresoTableMap::translateFieldName('Egresoid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->egresoid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TblegresoTableMap::translateFieldName('Numero', TableMap::TYPE_PHPNAME, $indexType)];
            $this->numero = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TblegresoTableMap::translateFieldName('Fecha', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->fecha = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TblegresoTableMap::translateFieldName('Comentario', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = TblegresoTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\Tblegreso'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTblegresoQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Tblegreso::setDeleted()
     * @see Tblegreso::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTblegresoQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TblegresoTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TblegresoTableMap::COL_EGRESOID)) {
            $modifiedColumns[':p' . $index++]  = 'egresoId';
        }
        if ($this->isColumnModified(TblegresoTableMap::COL_NUMERO)) {
            $modifiedColumns[':p' . $index++]  = 'numero';
        }
        if ($this->isColumnModified(TblegresoTableMap::COL_FECHA)) {
            $modifiedColumns[':p' . $index++]  = 'fecha';
        }
        if ($this->isColumnModified(TblegresoTableMap::COL_COMENTARIO)) {
            $modifiedColumns[':p' . $index++]  = 'comentario';
        }

        $sql = sprintf(
            'INSERT INTO tblegreso (%s) VALUES (%s)',
    ...
    {
        $pos = TblegresoTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Tblegreso'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Tblegreso'][$this->hashCode()] = true;
        $keys = TblegresoTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getEgresoid(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\Tblegreso
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\Tblegreso The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TblegresoTableMap::COL_EGRESOID)) {
            $criteria->add(TblegresoTableMap::COL_EGRESOID, $this->egresoid);
        }
        if ($this->isColumnModified(TblegresoTableMap::COL_NUMERO)) {
            $criteria->add(TblegresoTableMap::COL_NUMERO, $this->numero);
        }
        if ($this->isColumnModified(TblegresoTableMap::COL_FECHA)) {
            $criteria->add(TblegresoTableMap::COL_FECHA, $this->fecha);
        }
        if ($this->isColumnModified(TblegresoTableMap::COL_COMENTARIO)) {
            $criteria->add(TblegresoTableMap::COL_COMENTARIO, $this->comentario);
        }
    ...
    {
        $criteria = ChildTblegresoQuery::create();
        $criteria->add(TblegresoTableMap::COL_EGRESOID, $this->egresoid);
    ...
    /**
     * Generic method to set the primary key (egresoid column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\Tblegreso (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setEgresoid(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\Tblegreso Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildTblegreso is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTblegreso The current object (for fluent API support)
     */
    public function setTblegresodetalles(Collection $tblegresodetalles, ConnectionInterface $con = null)
    {
        ...
        foreach ($tblegresodetallesToDelete as $tblegresodetalleRemoved) {
            $tblegresodetalleRemoved->setTblegreso(null);
        }
    ...
    protected function doAddTblegresodetalle(ChildTblegresodetalle $tblegresodetalle)
    {
        ...
        $tblegresodetalle->setTblegreso($this);
    }
     ...
     * Otherwise if this Tblegreso is new, it will return
     * an empty collection; or if this Tblegreso has previously
     * been saved, it will retrieve related Tblegresodetalles from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Tblegreso.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildTblegresodetalle[] List of ChildTblegresodetalle objects
     */
    public function getTblegresodetallesJoinTblproductos(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTblegresodetalleQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(TblegresoTableMap::DEFAULT_STRING_FORMAT);
    }
