...
/**
 * Base class that represents a row from the 'tblrol' table.
 *
 *
 *
 * @package    propel.generator.propel.propel.Base
 */
abstract class Tblrol implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\TblrolTableMap';
    ...
    /**
     * Initializes internal state of propel\propel\Base\Tblrol object.
     */
    ...
    /**
     * Compares this with another <code>Tblrol</code> instance.  If
     * <code>obj</code> is an instance of <code>Tblrol</code>, delegates to
     * <code>equals(Tblrol)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Tblrol The current object, for fluid interface
     */
     ...
     * @return $this|\propel\propel\Tblrol The current object (for fluent API support)
     */
    public function setRolid($v)
    {
        ...
        if ($this->rolid !== $v) {
            $this->rolid = $v;
            $this->modifiedColumns[TblrolTableMap::COL_ROLID] = true;
        }
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[TblrolTableMap::COL_NOMBRE] = true;
        }
    ...
    public function setEstado($v)
    {
        ...
        if ($this->estado !== $v) {
            $this->estado = $v;
            $this->modifiedColumns[TblrolTableMap::COL_ESTADO] = true;
        }
    ...
    public function setFecha($v)
    {
        ...
        if ($this->fecha !== null || $dt !== null) {
            if ($this->fecha === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->fecha->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[TblrolTableMap::COL_FECHA] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TblrolTableMap::translateFieldName('Rolid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rolid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TblrolTableMap::translateFieldName('Nombre', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nombre = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TblrolTableMap::translateFieldName('Estado', TableMap::TYPE_PHPNAME, $indexType)];
            $this->estado = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TblrolTableMap::translateFieldName('Fecha', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = TblrolTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\propel\\propel\\Tblrol'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTblrolQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Tblrol::setDeleted()
     * @see Tblrol::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTblrolQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TblrolTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TblrolTableMap::COL_ROLID)) {
            $modifiedColumns[':p' . $index++]  = 'rolId';
        }
        if ($this->isColumnModified(TblrolTableMap::COL_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = 'nombre';
        }
        if ($this->isColumnModified(TblrolTableMap::COL_ESTADO)) {
            $modifiedColumns[':p' . $index++]  = 'estado';
        }
        if ($this->isColumnModified(TblrolTableMap::COL_FECHA)) {
            $modifiedColumns[':p' . $index++]  = 'fecha';
        }

        $sql = sprintf(
            'INSERT INTO tblrol (%s) VALUES (%s)',
    ...
    {
        $pos = TblrolTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Tblrol'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Tblrol'][$this->hashCode()] = true;
        $keys = TblrolTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\Tblrol
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\Tblrol The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TblrolTableMap::COL_ROLID)) {
            $criteria->add(TblrolTableMap::COL_ROLID, $this->rolid);
        }
        if ($this->isColumnModified(TblrolTableMap::COL_NOMBRE)) {
            $criteria->add(TblrolTableMap::COL_NOMBRE, $this->nombre);
        }
        if ($this->isColumnModified(TblrolTableMap::COL_ESTADO)) {
            $criteria->add(TblrolTableMap::COL_ESTADO, $this->estado);
        }
        if ($this->isColumnModified(TblrolTableMap::COL_FECHA)) {
            $criteria->add(TblrolTableMap::COL_FECHA, $this->fecha);
        }
    ...
    {
        $criteria = ChildTblrolQuery::create();
        $criteria->add(TblrolTableMap::COL_ROLID, $this->rolid);
    ...
    /**
     * Generic method to set the primary key (rolid column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\Tblrol (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\Tblrol Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildTblrol is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTblrol The current object (for fluent API support)
     */
    public function setUsuarioss(Collection $usuarioss, ConnectionInterface $con = null)
    {
        ...
        foreach ($usuariossToDelete as $usuariosRemoved) {
            $usuariosRemoved->setTblrol(null);
        }
     ...
     * Otherwise if this Tblrol is new, it will return
     * an empty collection; or if this Tblrol has previously
     * been saved, it will retrieve related Usuarioss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Tblrol.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildUsuarios[] List of ChildUsuarios objects
     */
    public function getUsuariossJoinTblmenu(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildUsuariosQuery::create(null, $criteria);
        $query->joinWith('Tblmenu', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(TblrolTableMap::DEFAULT_STRING_FORMAT);
    }
