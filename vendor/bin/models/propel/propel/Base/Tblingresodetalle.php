...
/**
 * Base class that represents a row from the 'tblingresodetalle' table.
 *
 *
 *
 * @package    propel.generator.propel.propel.Base
 */
abstract class Tblingresodetalle implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\propel\\propel\\Map\\TblingresodetalleTableMap';
    ...
    /**
     * The value for the ingresodetalleid field.
     *
     * @var        string
     */
    protected $ingresodetalleid;
    ...
    /**
     * Initializes internal state of propel\propel\Base\Tblingresodetalle object.
     */
    ...
    /**
     * Compares this with another <code>Tblingresodetalle</code> instance.  If
     * <code>obj</code> is an instance of <code>Tblingresodetalle</code>, delegates to
     * <code>equals(Tblingresodetalle)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Tblingresodetalle The current object, for fluid interface
     */
    ...
    /**
     * Get the [ingresodetalleid] column value.
     *
     * @return string
     */
    public function getIngresodetalleid()
    {
        return $this->ingresodetalleid;
    }
     ...
     */
    public function setIngresodetalleid($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->ingresodetalleid !== $v) {
            $this->ingresodetalleid = $v;
            $this->modifiedColumns[TblingresodetalleTableMap::COL_INGRESODETALLEID] = true;
        }
    ...
    public function setCantidad($v)
    {
        ...
        if ($this->cantidad !== $v) {
            $this->cantidad = $v;
            $this->modifiedColumns[TblingresodetalleTableMap::COL_CANTIDAD] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TblingresodetalleTableMap::translateFieldName('Ingresodetalleid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ingresodetalleid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TblingresodetalleTableMap::translateFieldName('Ingresoid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ingresoid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TblingresodetalleTableMap::translateFieldName('Productoid', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTblingresodetalleQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Tblingresodetalle::setDeleted()
     * @see Tblingresodetalle::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTblingresodetalleQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TblingresodetalleTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aTblingreso !== null) {
                if ($this->aTblingreso->isModified() || $this->aTblingreso->isNew()) {
                    $affectedRows += $this->aTblingreso->save($con);
                }
                $this->setTblingreso($this->aTblingreso);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TblingresodetalleTableMap::COL_INGRESODETALLEID)) {
            $modifiedColumns[':p' . $index++]  = 'ingresoDetalleId';
        }
        if ($this->isColumnModified(TblingresodetalleTableMap::COL_INGRESOID)) {
            $modifiedColumns[':p' . $index++]  = 'ingresoId';
        }
        if ($this->isColumnModified(TblingresodetalleTableMap::COL_PRODUCTOID)) {
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'ingresoDetalleId':
                        $stmt->bindValue($identifier, $this->ingresodetalleid, PDO::PARAM_INT);
                        break;
                    case 'ingresoId':
    ...
    {
        $pos = TblingresodetalleTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIngresodetalleid();
                break;
            case 1:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Tblingresodetalle'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Tblingresodetalle'][$this->hashCode()] = true;
        $keys = TblingresodetalleTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIngresodetalleid(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aTblingreso) {
                ...
                $result[$key] = $this->aTblingreso->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\propel\propel\Tblingresodetalle
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIngresodetalleid($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIngresodetalleid($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setIngresoid($arr[$keys[1]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\propel\propel\Tblingresodetalle The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(TblingresodetalleTableMap::DATABASE_NAME);

        if ($this->isColumnModified(TblingresodetalleTableMap::COL_INGRESODETALLEID)) {
            $criteria->add(TblingresodetalleTableMap::COL_INGRESODETALLEID, $this->ingresodetalleid);
        }
        if ($this->isColumnModified(TblingresodetalleTableMap::COL_INGRESOID)) {
            $criteria->add(TblingresodetalleTableMap::COL_INGRESOID, $this->ingresoid);
        }
        if ($this->isColumnModified(TblingresodetalleTableMap::COL_PRODUCTOID)) {
            $criteria->add(TblingresodetalleTableMap::COL_PRODUCTOID, $this->productoid);
        }
        if ($this->isColumnModified(TblingresodetalleTableMap::COL_CANTIDAD)) {
    ...
    {
        $criteria = ChildTblingresodetalleQuery::create();
        $criteria->add(TblingresodetalleTableMap::COL_INGRESODETALLEID, $this->ingresodetalleid);
    ...
    {
        $validPk = null !== $this->getIngresodetalleid();
    ...
    /**
     * Generic method to set the primary key (ingresodetalleid column).
     *
    ...
    {
        return null === $this->getIngresodetalleid();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \propel\propel\Tblingresodetalle (or compatible) type.
    ...
    {
        $copyObj->setIngresodetalleid($this->getIngresodetalleid());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \propel\propel\Tblingresodetalle Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildTblingreso object.
     *
     * @param  ChildTblingreso $v
     * @return $this|\propel\propel\Tblingresodetalle The current object (for fluent API support)
     * @throws PropelException
     */
    public function setTblingreso(ChildTblingreso $v = null)
    {
        ...
        // If this object has already been added to the ChildTblingreso object, it will not be re-added.
        if ($v !== null) {
            $v->addTblingresodetalle($this);
        }
    ...
    /**
     * Get the associated ChildTblingreso object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildTblingreso The associated ChildTblingreso object.
     * @throws PropelException
     */
    public function getTblingreso(ConnectionInterface $con = null)
    {
        if ($this->aTblingreso === null && (($this->tblingreso_ingresoid !== "" && $this->tblingreso_ingresoid !== null))) {
            ...
            /* The following can be used additionally to
                ...
                $this->aTblingreso->addTblingresodetalles($this);
             */
        }

        return $this->aTblingreso;
    }
    ...
    public function getTblproductos(ConnectionInterface $con = null)
    {
        if ($this->aTblproductos === null && (($this->tblproductos_productoid !== "" && $this->tblproductos_productoid !== null))) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTblproductos->addTblingresodetalles($this);
             */
        }
    ...
    {
        if (null !== $this->aTblingreso) {
            $this->aTblingreso->removeTblingresodetalle($this);
        }
        if (null !== $this->aTblproductos) {
            $this->aTblproductos->removeTblingresodetalle($this);
        }
        $this->ingresodetalleid = null;
        $this->ingresoid = null;
    ...
    {
        return (string) $this->exportTo(TblingresodetalleTableMap::DEFAULT_STRING_FORMAT);
    }
