...
CREATE TABLE IF NOT EXISTS `agilcontador`.`tblproductos` (
  ...
  INDEX `fk_tblproductos_tbllinea1_idx` (`lineaId` ASC) ,
...
CREATE TABLE IF NOT EXISTS `agilcontador`.`tblegresodetalle` (
  ...
  INDEX `fk_tblegresodetalle_tblproductos1_idx` (`productoId` ASC) ,
  INDEX `fk_tblegresodetalle_tblegreso1_idx` (`egresoId` ASC) ,
...
CREATE TABLE IF NOT EXISTS `agilcontador`.`tblfactura` (
  ...
  INDEX `fk_tblfactura_tblcliente1_idx` (`clienteId` ASC) ,
  INDEX `fk_tblfactura_usuarios1_idx` (`usuarioId` ASC) ,
  INDEX `fk_tblfactura_tblmetodopago1_idx` (`metodoPagoId` ASC) ,
...
CREATE TABLE IF NOT EXISTS `agilcontador`.`tblfacturadetalle` (
  ...
  INDEX `fk_tblfacturadetalle_tblfactura1_idx` (`facturaId` ASC) ,
  INDEX `fk_tblfacturadetalle_tblproductos1_idx` (`productoId` ASC) ,
...
CREATE TABLE IF NOT EXISTS `agilcontador`.`tblingresodetalle` (
  ...
  INDEX `fk_tblingresodetalle_tblingreso1_idx` (`ingresoId` ASC) ,
  INDEX `fk_tblingresodetalle_tblproductos1_idx` (`productoId` ASC) ,
...
CREATE TABLE IF NOT EXISTS `agilcontador`.`tblmenu` (
  ...
  `usuarioId` BIGINT(20) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_tblmenu_usuarios1_idx` (`usuarioId` ASC) ,
  CONSTRAINT `fk_tblmenu_usuarios1`
    FOREIGN KEY (`usuarioId`)
    REFERENCES `agilcontador`.`usuarios` (`id_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `agilcontador`.`tblproductocosto` (
  ...
  INDEX `fk_tblproductocosto_tblproductos1_idx` (`productoId` ASC) ,
...
CREATE TABLE IF NOT EXISTS `agilcontador`.`tblproductoprecio` (
  ...
  `fecha` DATETIME NULL DEFAULT NULL,
  PRIMARY KEY (`productoPrecioId`),
  INDEX `fk_tblproductoprecio_tblproductos1_idx` (`productoId` ASC) ,
